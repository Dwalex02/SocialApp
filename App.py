...
class Registration(Resource):
    ...
    def post(self):
        ...
        gender = args['gender']
        today = date.today()
        #age verification - one that eliminates the possiblity that
        #17 years old can still sign up even if they haven't had their birthday, yet this year.
        #It works because it substracts the input year from today year and i also substract True/False statement.
        #If today month, day is < input month and day it says True which is equal to 1 and I substract it.
